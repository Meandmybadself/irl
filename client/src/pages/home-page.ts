    ...
    return html`
      <app-layout>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <a href="/directory" class="block bg-white p-6 rounded-lg shadow-sm no-underline text-inherit transition-all border-2 border-transparent hover:shadow-md hover:border-blue-500">
            <div class="text-4xl mb-3">📖</div>
            <h2 class="text-xl font-semibold text-gray-900 mb-2">
              Directory <span class="inline-block text-xs px-2 py-1 bg-yellow-100 text-yellow-800 rounded font-medium ml-2">Coming Soon</span>
            </h2>
            <p class="text-sm text-gray-600 leading-relaxed">Search the community directory</p>
          </a>
